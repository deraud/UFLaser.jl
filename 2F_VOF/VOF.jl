...
export set_equi!, update_rho_u!, collide!, get_epsilon, get_normal, interface_mass_exchange, average_surround!, lbm_collision!, lbm_streaming!, update_types!, evolve!
...
function set_equi!(domain::LBMDomain, ix::Int64, iy::Int64, rho_val::Float64, u_vec::Vector{Float64})
