...
using CSV
using Plots
Data = DataFrame(CSV.File("Dataset/gold_rear_200nm_PTS.csv"))
DataExperiment = DataFrame(CSV.File("Dataset/gold_rear_200nm.csv"))
...
savefig("1D/plotting1D/TeEvolution/200nm/Rear_200nm.png")